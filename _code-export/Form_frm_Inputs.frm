...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_frm_Inputs"
...
Private Sub Form_Close()
    Form_frm_Schemes.btn_Inputs.BackStyle = 0
End Sub
...
Private Sub Form_Load()
    ...
    FormHeader.BackColor = Pastel_0.Green
    Detail.BackColor = Pastel_0.Green
    FormFooter.BackColor = Pastel_0.Green
    
    cmb_Main.RowSource = std_Sql.cmb_Main_N
    ...
    Refresh_Controls
    Refresh_RecordSource
    Form_frm_Schemes.btn_Inputs.BackStyle = 1
...
Private Property Get Form_Title() As String
    Form_Title = "Input Documents   ~   No selection"
    ...
    If frm.Recordset.RecordCount > 0 Then
        ...
        Form_Title = "Input Documents   ~   " & prefix & dir & "  /  " & mod_StringUtils.StripNonAsciiChars(Title)
    End If
End Property

Private Sub lbl_Filestage_Click()
...
Public Sub Refresh_RecordSource()
    ...
    If cmb_Main = 1 Then
        If chk_Deleted Then
            strSql = std_Sql.Inputs_old
        Else
            strSql = std_Sql.Inputs_current
        End If
    Else
        strSql = std_Sql.Inputs_byCriteria
