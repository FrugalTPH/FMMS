...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_frm_Memoranda"
...
Private Sub Form_Close()
    Form_frm_Schemes.btn_Memoranda.BackStyle = 0
End Sub
...
Private Sub Form_Load()
    ...
    FormHeader.BackColor = Pastel_0.Red
    Detail.BackColor = Pastel_0.Red
    FormFooter.BackColor = Pastel_0.Red
    
    cmb_Main.RowSource = std_Sql.cmb_Main_M
    ...
    Refresh_Controls
    Refresh_RecordSource
    Form_frm_Schemes.btn_Memoranda.BackStyle = 1
...
Private Property Get Form_Title() As String
    Form_Title = "Memoranda   ~   No selection"
    ...
    If frm.Recordset.RecordCount > 0 Then
        ...
        Form_Title = "Memoranda   ~   " & prefix & dir & "  /  " & mod_StringUtils.StripNonAsciiChars(Title)
    End If
End Property
...
Public Sub Refresh_RecordSource()
    ...
    If cmb_Main = 1 Then
        If chk_Deleted Then
            strSql = std_Sql.Memoranda_old
        Else
            strSql = std_Sql.Memoranda_current
        End If
    Else
        strSql = std_Sql.Memoranda_byCriteria
