...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_frm_People"
...
Private Sub Form_Close()
    Form_frm_Schemes.btn_People.BackStyle = 0
End Sub
...
Private Sub Form_Load()
    ...
    FormHeader.BackColor = Pastel_0.Yellow
    Detail.BackColor = Pastel_0.Yellow
    FormFooter.BackColor = Pastel_0.Yellow
    
    cmb_Main.RowSource = std_Sql.cmb_Main_P
    ...
    Refresh_RecordSource
    Refresh_Controls
    Form_frm_Schemes.btn_People.BackStyle = 1
...
Private Property Get Form_Title() As String
    Form_Title = "People   ~   No selection"
    ...
    If frm.Recordset.RecordCount > 0 Then
        ...
        Form_Title = "People   ~   " & prefix & dir & "  /  " & mod_StringUtils.StripNonAsciiChars(Title)
    End If
End Property
...
Public Sub Refresh_RecordSource()
    ...
    If cmb_Main = 1 Then
        If chk_Deleted Then
            strSql = std_Sql.People_old
        Else
            strSql = std_Sql.People_current
        End If
    Else
        strSql = std_Sql.People_byCriteria
